    ...
    <main key="1" className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-2xl mb-8">
        ...
        <p className="text-center mb-8">
          Tailor your package to fit your needs. Choose the number of influencers, your preferred platform, and pick
          your outreach goals.
        </p>
        ...
        <p className="text-gray-500 mb-4">Select the desired outreach goal for your influencer marketing campaign.</p>
        <Select>
        ...
        <div className="border p-4 rounded-lg">
          <p className="font-semibold">This audience is primarily interested in fitness and health products.</p>
          <hr className="my-2" />
          ...
          <hr className="my-2" />
          <p className="font-semibold">
            This group is composed of outdoor enthusiasts who enjoy camping, hiking, and other outdoor activities.
          </p>
          <hr className="my-2" />
          <p className="font-semibold">This audience is interested in personal finance and investment opportunities.</p>
          <hr className="my-2" />
          <p className="font-semibold">
        ...
        <div className="p-6 rounded-lg bg-white shadow-md border border-gray-200">
          ...
          <p className="text-gray-500 mb-4">
            Proceed securely with Stripe. Our AI, backed by human guarantee, ensures quality results. If unsatisfied, we
